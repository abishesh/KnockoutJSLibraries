var widget = (function($, ko) {
        ...
        ko.renderTemplate(
            ...
            // The resolve function receives the element.
            {
                afterRender: function(nodes) {
                    ...
                    //});
                    var elements = $(nodes).filter(function() {
    ...
    var showModal = function(options) {
        ...
        var bindings = options.afterRender;
        ...
        return createModalElement(template, viewModel)
            ...
            .pipe(function($ui) {
                ...
                showTwitterBootstrapModal($ui, bindings, callBack);
    ...
    var showTwitterBootstrapModal = function ($ui, bindings, callBack) {
        ...
        if (typeof bindings !== "undefined" && bindings instanceof Function) {
            bindings();
        }
    };
    ...
    var showConfirm = function (message, template) {
        var vm = {
            message: message,
            ok: function () { this.modal.close(true); },
            cancel: function () { this.modal.close(false); }
        };
        var options = { viewModel: vm, template: template, context: this };
        return showModal(options);
    };

    var showDialog = function (title,message,doneText,cancelText, template) {
        var vm = {
            title:title,
            message: message,
            doneText: doneText,
            cancelText:cancelText,
            done: function () { this.modal.close(true); },
            cancel: function () { this.modal.close(false); }
        };
        var options = { viewModel: vm, template: template, context: this };
        return showModal(options);
